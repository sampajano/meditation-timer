...
Golden Meditation Timer is an iOS-first meditation timer. The production iPhone app is a native UIKit/SwiftUI app implemented in `ios/App/GoldenMeditationApp/AppDelegate.swift`. The React + Vite code under `web/` is a separate web implementation and build source for shared static assets.
